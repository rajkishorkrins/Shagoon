...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Efficient, on-time fuel services with utmost safety and compliance.",
  },
  {
    icon: Crown,
  ...
  },
  {
    ...
    title: "Military OPS",
    description:
      "Dedicated solutions for secure, mission-critical aviation support.",
  },
  // {
  //     icon: PlaneLanding,
...
function Solution() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-light py-24"
    >
      {/* Header */}
