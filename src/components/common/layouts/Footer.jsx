        ...
        <footer className="overflow-hidden bg-secondary text-white">
            ...
            <section className="relative">
                ...
                >
                    ...
                    >
                        From defence logistics to aviation refueling and specialized cargo
                        handling, Air Shagoon Group delivers reliable aviation solutions
                        across India.
                    </motion.p>
            ...
            >
                ...
                <motion.div variants={column}>
                    <p className="mt-6 leading-7 text-white/70">
                        Air Shagoon Group has been delivering trusted aviation,
                        defence and logistics solutions for over 35 years,
                        serving government, military and commercial sectors.
                    </p>
                </motion.div>
